...
public class CreateInvestigationAPI {


        Context context;
        String result = "";
        ProgressDialog progressDialog;
        CreateInvestigationListener resultOutput;

        public CreateInvestigationAPI(Context context, CreateInvestigationListener resultOutput) {
