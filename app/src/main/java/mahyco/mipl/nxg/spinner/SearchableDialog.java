...
public class SearchableDialog extends DialogFragment implements
        SearchView.OnQueryTextListener, SearchView.OnCloseListener{

    private static final String ITEMS = "items";

    private SearchSpinnerAdapter listAdapter;
    ...
    public static SearchableDialog newInstance(List items) {
        SearchableDialog multiSelectExpandableFragment = new
                SearchableDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.search_dialog, null);
        setData(rootView);
    ...
    private void setData(View rootView) {
        ...
        _searchView = (android.widget.SearchView) rootView.findViewById(R.id.search);
        ...
        listAdapter = new SearchSpinnerAdapter(getActivity(), android.R.layout.simple_list_item_1, items);        //attach the adapter to the list
...
//                _listViewItems.clearTextFilter();
            ((SearchSpinnerAdapter) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
            ((SearchSpinnerAdapter) _listViewItems.getAdapter()).getFilter().filter(s);
        }
